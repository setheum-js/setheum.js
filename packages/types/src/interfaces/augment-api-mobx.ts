...
export interface StorageType extends BaseStorageType {
  ...
  incentives: {    /**
     ...
     **/
    dexSavingRewardRate: StorageMap<PoolId | { LoansIncentive: any } | { DexIncentive: any } | { DexSaving: any } | string, Rate>;
    /**
     * Mapping from pool to its fixed reward amount per period.
     * 
     * IncentiveRewardAmount: map PoolId => Balance
     **/
    incentiveRewardAmount: StorageMap<PoolId | { LoansIncentive: any } | { DexIncentive: any } | { DexSaving: any } | string, Balance>;
  };
  indices: {    /**
  ...
  rewards: {    /**
     ...
     **/
    pools: StorageMap<PoolId | { LoansIncentive: any } | { DexIncentive: any } { DexSaving: any } | string, PoolInfo>;
    /**
     * Record share amount and withdrawn reward amount for specific `AccountId`
     * under `PoolId`.
     **/
    shareAndWithdrawnReward: StorageDoubleMap<PoolId | { LoansIncentive: any } | { DexIncentive: any } { DexSaving: any } | string, AccountId | string, ITuple<[Share, Balance]>>;
  };
  scheduler: {    /**
