...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    airDrop: {
      airDrops: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: AirDropCurrencyId | 'KAR' | 'DNAR' | number | Uint8Array) => Observable<Balance>, [AccountId, AirDropCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId, AirDropCurrencyId]>;
      /**
       * Generic query
       **/
