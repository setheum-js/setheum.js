...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    ...
    dex: {
       ...
       * Get supply amount
       **/
      getSupplyAmount: AugmentedRpc<(supplyCurrencyId: CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | { ChainBridge: any } | string | Uint8Array, targetCurrencyId: CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | { ChainBridge: any } | string | Uint8Array, targetCurrencyAmount: BalanceRequest | { amount?: any } | string | Uint8Array) => Observable<BalanceWrapper>>;
      /**
       * Get target amount
       **/
      getTargetAmount: AugmentedRpc<(supplyCurrencyId: CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | { ChainBridge: any } | string | Uint8Array, targetCurrencyId: CurrencyId | { Token: any } | { DEXShare: any } | { ERC20: any } | { ChainBridge: any } | string | Uint8Array, supplyCurrencyAmount: BalanceRequest | { amount?: any } | string | Uint8Array) => Observable<BalanceWrapper>>;
    };
    engine: {
      /**
    ...
    oracle: {
       ...
       **/
      getValue: AugmentedRpc<(providerId: RpcDataProviderId | string, key: OracleKey | { Token: any } | { DEXShare: any } | { ERC20: any } | { ChainBridge: any } | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<Option<TimestampedValue>>>;
    };
    payment: {
      /**
