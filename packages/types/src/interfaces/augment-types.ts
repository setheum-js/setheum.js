...
import type { AirDropCurrencyId, Amount, AmountOf, AuctionId, AuctionIdOf, AuthoritysOriginId, CurrencyId, CurrencyIdOf, DexShare, SerpStableCurrencyId, SetheumAssetMetadata, SetheumDataProviderId, TokenInfo, TokenSymbol, TradingPair } from '@setheum.js/types/interfaces/primitives';
